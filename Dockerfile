...
CMD php artisan migrate --force && php artisan shield:install --panel=admin && php artisan shield:generate --all && php artisan db:seed --class=AdminSeeder --force && php artisan serve --host=0.0.0.0 --port=${PORT:-8080}
